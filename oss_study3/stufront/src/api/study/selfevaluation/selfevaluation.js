...
const api = {
	...
	saveDTO: (params, successCallback, failCallback, exceptionCallback) => {
		ApiUtils.postLoadingAjax(constant.serverUrl + "/study/selfevaluation/saveDTO", params, successCallback, failCallback, exceptionCallback);
	},

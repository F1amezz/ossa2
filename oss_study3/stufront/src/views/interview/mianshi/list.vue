      ...
      <el-button type="primary" icon="el-icon-plus" @click="toSave()"
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="dbColumn_postid" label="岗位"></el-table-column>			
				...
				<el-table-column label="操作" fixed="right" width="280px">
					<template slot-scope="scope">
						<div class="dataTable-operator">
                            ...
                            <el-button    size="mini" @click="toDianpin(scope.row)">修改</el-button>
						    <el-button    size="mini" @click="toUpdate( scope.row )">总结</el-button>
